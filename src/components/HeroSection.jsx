  ...
  return (
    <section
      style={{
        ...
        position: 'relative',
        overflow: 'hidden',
        fontFamily: "'Inter', sans-serif", // ✅ body font added
      }}
    >
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            background:'#EEF2FF', border:'1.5px solid #C7D7FD',
            ...
            <span style={{
              fontSize:12.5, fontWeight:700, color:'#1B4FD8',
          ...
          <div style={{ display:'flex', flexWrap:'wrap', gap:14, marginBottom:44 }}>
            ...
            <SafeWhatsAppButton
              ...
              onMouseEnter={e => {
                e.currentTarget.style.transform = 'translateY(-2px)';
                e.currentTarget.style.boxShadow = '0 14px 36px rgba(37,211,102,0.42)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 6px 24px rgba(37,211,102,0.32)';
              }}
            >
              💬 WhatsApp
            </SafeWhatsAppButton>
        ...
        <div style={{
          ...
          <div style={{
            ...
            aspectRatio:'4/3', background:'#E2E8F0',
          ...
          <FloatBadge style={{ bottom:-26, left:-26 }}>
            <div style={{ textAlign:'center' }}>
              <div style={{
                fontSize:28, fontWeight:900, color:'#1B4FD8',
          ...
          <div style={{
            ...
            padding:'14px 20px', textAlign:'center', minWidth:82,
          ...
          <FloatBadge style={{ bottom:28, right:-22 }}>
            ...
            <div>
              <div style={{ fontSize:13, fontWeight:800, color:'#92400E', lineHeight:1.2 }}>
                4.9 / 5.0
              </div>
